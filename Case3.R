...
for(i in 1: 5) {
  beta1[i] <- (replicate(1000, simu_SCPT_C(s = means_det[i], ns = 1)$result) > 0) |> 
                which() |>
                length() / 1000
}
...
for(i in 1: 5) {
  beta3[i] <- (replicate(1000, simu_SCPT_C(s = means_det[i], ns = 3)$result) > 0) |>
                which() |>
                length() / 1000
}
...
for(i in 1: 5) {
  beta5[i] <- (replicate(1000, simu_SCPT_C(s = means_det[i], ns = 5)$result) > 0) |>
                which() |>
                length() / 1000
}
...
for(i in 1: 5) {
  beta10[i] <- (replicate(1000, simu_SCPT_C(s = means_det[i], ns = 10)$result) > 0) |>
                which() |>
                length() / 1000
}
...
for(i in 1: 5) {
  size1[i] <- replicate(1000, simu_SCPT_C(s = means_det[i], ns = 1)$bouts) |> 
              mean()
}
...
for(i in 1: 5) {
  size3[i] <- replicate(1000, simu_SCPT_C(s = means_det[i], ns = 3)$bouts) |>
              mean()
}
...
for(i in 1: 5) {
  size5[i] <- replicate(1000, simu_SCPT_C(s = means_det[i], ns = 5)$bouts) |>
              mean()
}
...
for(i in 1: 5) {
  size10[i] <- replicate(1000, simu_SCPT_C(s = means_det[i], ns = 10)$bouts) |>
               mean()
}
...
for(i in 1: 5) {
  betaGreen30[i] <- (replicate(1000, sum(sample(rpois(lambda = means_det[i], n = 100000), size = 30, replace = F))) > 0) |>
                    which() |>
                    length() / 1000
}
...
for(i in 1: 5) {
  betaGreen20[i] <- (replicate(1000, sum(sample(rpois(lambda = means_det[i], n = 100000), size = 20, replace = F))) > 0) |>
                    which() |>
                    length() / 1000
}
...
for(i in 1: 5) {
  betaGreen10[i] <- (replicate(1000, sum(sample(rpois(lambda = means_det[i], n = 100000), size = 10, replace = F))) > 0) |>
                    which() |>
                    length() / 1000
}
